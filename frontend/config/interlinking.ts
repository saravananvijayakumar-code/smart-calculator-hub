...
export const CALCULATOR_INTERLINKS: Record<string, InterlinkingConfig> = {
  'bmi': {
...
export const DIRECTORY_INTERLINKS: Record<string, string[]> = {
...
export function getRelatedCalculators(calculatorId: string): string[] {
  return CALCULATOR_INTERLINKS[calculatorId]?.relatedCalculators || [];
}

export function getRelatedDirectories(calculatorId: string): string[] {
  return CALCULATOR_INTERLINKS[calculatorId]?.relatedDirectories || [];
}

export function getDirectoryInterlinks(directoryPath: string): string[] {
