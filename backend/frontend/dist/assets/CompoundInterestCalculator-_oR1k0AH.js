import { j as jsxRuntimeExports, f as Card, g as CardHeader, h as CardTitle, T as TrendingUp, k as CardContent, a4 as Label, V as Input, a5 as Info, r as reactExports, aD as useTranslation, ae as useFormatting } from "./index-CK9G4vW7.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: inputs.frequency, onValueChange: (value) => onInputChange("frequency", value), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: inputs.contributionTiming, onValueChange: (value) => onInputChange("contributionTiming", value), children: [
...
function CompoundInterestResults({ result, formatCurrency }) {
  if (!result.isValid) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-green-200 bg-green-50", children: [
...
function CompoundInterestScenarios({ scenarios, formatCurrency }) {
...
function CompoundInterestBreakdown({ breakdown, formatCurrency }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: breakdown.map((year) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b hover:bg-gray-50", children: [
...
function CompoundInterestEducation() {
...
function useCompoundInterestCalculator(inputs) {
  ...
  const calculateCompoundInterest = () => {
    ...
    if (p > 0 && r >= 0 && t > 0 && n > 0) {
      ...
      const effectiveAnnualRate = totalContributionsSum > 0 ? (Math.pow(finalAmount / totalContributionsSum, 1 / t) - 1) * 100 : 0;
      setResult({
        finalAmount,
        totalInterest,
  ...
  const calculateComparisonScenarios = (p, r, t, n, pmt) => {
    const scenarios = [];
    if (pmt > 0) {
  ...
  const calculateScenario = (p, r, t, n, pmt) => {
    const monthlyRate = r / 100 / 12;
    let balance = p;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    CalculatorLayoutWithAds,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AdsterraSlot, { position: "middle", className: "my-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CompoundInterestEducation, {})
      ] })
    }
  );
}
